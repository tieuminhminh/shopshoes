            ...
            <div class="owl-carousel owl-theme home_slider">
                ...
                <div class="owl-item home_slider_item">
                    <div class="home_slider_background"
                         style="background-image:url(view/lib/images/home_slider_1.jpg)"></div>
    ...
    <div class="avds">
        <div class="avds_container d-flex flex-lg-row flex-column align-items-start justify-content-between">
            <div class="avds_small">
                <div class="avds_background" style="background-image:url(view/lib/images/avds_small.jpg)"></div>
            ...
            <div class="avds_large">
                <div class="avds_background" style="background-image:url(view/lib/images/avds_large.jpg)"></div>
            ...
            <div class="row">
                <div class="col">
                    <div class="avds_xl_container clearfix">
                        <div class="avds_xl_background" style="background-image:url(view/lib/images/avds_xl.jpg)"></div>
