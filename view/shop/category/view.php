                ...
                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                    <div class="right-all-product">
                        ...
                        <div class="product-category-header">
                            <div class="category-header-image">
                                <img src="view/shop/lib/img/category-header.jpg" alt="category-header">
                        ...
                        <div class="product-shooting-area">
                            <div class="product-shooting-bar">
                                ...
                                <div class="view-systeam">
                                    ...
                                    <ul>
                                        <li class="active"><a href="view/shop/category/view.php"><i class="fa fa-th-large"></i></a><br>Grid</li>
                                        <li><a href="view/shop/category/listView.php"><i class="fa fa-th-list"></i></a><br>List</li>
                                    </ul>
                                </div>
                                <!-- VIEW-SYSTEAM END -->
                            </div>
                    ...
                    <ul class="gategory-product">
                        ...
                        <li class="gategory-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
                            <div class="single-product-item">
                                <div class="product-image">
                                    <a href="single-product.html"><img src="view/shop/lib/img/product/sale/3.jpg" alt="product-image"></a>
                        ...
                        <li class="gategory-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
                            <div class="single-product-item">
                                <div class="product-image">
                                    <a href="single-product.html"><img src="view/shop/lib/img/product/sale/1.jpg" alt="product-image"></a>
                        ...
                        <li class="gategory-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
                            <div class="single-product-item">
                                <div class="product-image">
                                    <a href="single-product.html"><img src="view/shop/lib/img/product/sale/9.jpg" alt="product-image"></a>
                                    <a href="single-product.html" class="new-mark-box">sale!</a>
                                    <div class="overlay-content">
                                        <ul>
                                            <li><a href="#" title="Quick view"><i class="fa fa-search"></i></a></li>
                        ...
                        <li class="gategory-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
                            <div class="single-product-item">
                                <div class="product-image">
                                    <a href="single-product.html"><img src="view/shop/lib/img/product/sale/5.jpg" alt="product-image"></a>
                                    <a href="single-product.html" class="new-mark-box">new</a>
                                    <div class="overlay-content">
                                        <ul>
                                            <li><a href="#" title="Quick view"><i class="fa fa-search"></i></a></li>
